...
public class EasyUtils {
	 ...
	 * @throws Exception
	 */
	public static boolean rsaVerifySign(String resultStr, String easypay_pub_key){
		try {
			String returnString = org.apache.commons.lang.StringUtils.substringBetween(resultStr,"response\":", ",\"sign\"");
			String returnSign = org.apache.commons.lang.StringUtils.substringBetween(resultStr,",\"sign\":\"","\"}");
			return AlipaySignature.rsaCheckContent(returnString, returnSign, easypay_pub_key, "UTF-8");
		}catch(Exception e) {
			e.printStackTrace();
		}
		return false;
	...
	public static void main(String[] args) throws Exception {
		...
		boolean isTrue=AlipaySignature.rsaCheckContent(returnString, returnSign, EasyKeyUtils.EASYPAY_PUBLIC_KEY, "UTF-8");
