...
public class EasyDesUtil {
    ...
    public static String encode(String key, String data) {
        try {
            ...
            byte[] valueByte = EasyDesUtil.des3Encryption(keyByte, dataByte);
    ...
    public static String decode(String key, String data) {
        try {
            ...
            byte[] valueByte = EasyDesUtil.des3Decryption(keyByte, dataByte);
...
//            cipher.init(Cipher.ENCRYPT_MODE, k);
	...
	public static String desDecode(String data, String key) {
		try {
			...
			return new String(cipher.doFinal(EasyUtils.hexStrToBytes(data)));
		} catch (Exception e) {
			return null;
		}
	}
