...
public class ServletUtils {
	 ...
	 * @throws
	 */
	public static String buildParamString(Map<String, Object> params, String[] paramNames) {
		if (ArrayUtils.isEmpty(paramNames)) {
			return "";
		}
		
		ToStringBuilder builder = new ToStringBuilder(null, new MapToStringStyle());
		for (String paramName : paramNames) {
			if (params.containsKey(paramName)) {
				builder.append(paramName, params.get(paramName));
			}
		}
		builder.getStringBuffer().setLength(builder.getStringBuffer().length() - 1);
