...
import com.chunruo.core.util.expection.NestedException;
...
public class JsonMapperUtil {
	...
	public JsonMapperUtil(Inclusion inclusion) {
	...
	public static JsonMapperUtil buildNormalMapper() {
		return new JsonMapperUtil(Inclusion.ALWAYS);
	}
	...
	public static JsonMapperUtil buildNonNullMapper() {
		return new JsonMapperUtil(Inclusion.NON_NULL);
	}
	...
	public static JsonMapperUtil buildNonDefaultMapper() {
		return new JsonMapperUtil(Inclusion.NON_DEFAULT);
	}
	...
	public static JsonMapperUtil buildNonEmptyMapper() {
		return new JsonMapperUtil(Inclusion.NON_EMPTY);
	}
	...
	public static String toNormalJson(Object object){
		return new JsonMapperUtil(Inclusion.ALWAYS).toJson(object);
	}
	...
	public static String toNonNullJson(Object object){
		return new JsonMapperUtil(Inclusion.NON_NULL).toJson(object);
	}
	...
	public static String toNonDefaultJson(Object object){
		return new JsonMapperUtil(Inclusion.NON_DEFAULT).toJson(object);
	}
	...
	public static String toNonEmptyJson(Object object){
		return new JsonMapperUtil(Inclusion.NON_EMPTY).toJson(object);
	}
