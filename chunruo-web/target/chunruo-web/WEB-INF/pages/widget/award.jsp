...
<script type="text/javascript">
        ...
        if (pageList && pageList.length > 0) {
            ...
            for (var i = 0, len = 1; i < len; i++) {
                html += '<tr><td class="title" style="max-width: 300px;">' +
                    '<div class="td-cont">' +
                    '<a class="new_window" href="javascript:void(0);">奖励中心</a>' +
                    '</div>' +
                    '</td> ' +
                    '<td class="time"> ' +
                    '<div class="td-cont"> ' +
                    ...
                    '<td class="opts">' +
                    '<div class="td-cont">' +
                    '<button class="btn js-choose" onclick="selectProduct(this)" data-id="' + pageList[i].taskId + '" data-title="' + pageList[i].taskName + '" data-image="/upload/' + pageList[i].imagePath + '">选取</button>' +
                    '</div></td></tr>'
            }
    ...
    function selectProduct(obj) {
        ...
        if (type && type != "null" && type == 1) {
            parent.login_box_after(parent.randNum, 'award', '', $(obj).data('id'));
        } else {
