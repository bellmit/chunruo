...
<script type="text/javascript">
        ...
        $("#pagediv").html("");
            ...
            var pageHtml = "";
                html += '<tr><td class="title" style="max-width: 300px;">' +
                    '<div class="td-cont">' +
                    '<a class="new_window" href="javascript:void(0);">邀请有礼</a>' +
                    '</div>' +
                    '</td> ' +
                    '<td class="time"> ' +
                    '<div class="td-cont"> ' +
                    ...
                    '<td class="opts">' +
                    '<div class="td-cont">' +
                    '<button class="btn js-choose" onclick="selectProduct(this)" data-id="' + 0 + '" data-title="' + 1+ '" data-price="' + 2 + '" data-image="/upload/' + 3 + '">选取</button>' +
                    '</div></td></tr>'
    ...
    function selectProduct(obj) {
        ...
        if (type && type != "null" && type == 1) {
            parent.login_box_after(parent.randNum, 'invite', '', $(obj).data('id'));
        } else {
