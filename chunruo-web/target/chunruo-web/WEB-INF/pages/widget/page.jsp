...
var pageId = commFun.getUrlPara("pageId");
    $(function() {
    	var channelId = commFun.getUrlPara("channelId");
    	var pageId = commFun.getUrlPara("pageId");
        sendAjax.get("widget/getPageList", {
            channelId: channelId,
            pageId: pageId,
        ...
        $('button.js-choose').live('click', function() {
            ...
            parent.login_box_after(parent.randNum, 'page', $(this).data('title'), $(this).data('id'));
        });
        ...
        if (pageList && pageList.length > 0) {
            ...
            for (var i = 0, len = pageList.length; i < len; i++) {
                html += '<tr>' +
                    ...
                    '<td class="opts">' +
                    '<div class="td-cont">' +
                    '<button class="btn js-choose" data-id="' + pageList[i].pageId + '" data-title="' + pageList[i].pageName + '">选取</button>' +
                    '</div></td></tr>'
            }
