...
Ext.define('MyExt.activityManager.InfoCodeImageListPanel', {
    ...
    initComponent : function(config) {
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/activity/infoList.json?level=5"/>',
				reader: {
					type : 'json',
                	root: 'data',
				...
				Ext.MessageBox.confirm('<fmt:message key="ajax.confirm"/>', '<fmt:message key="save.confirm"/>', function(e){
					if(e == 'yes'){
	             		infoFormPanel.form.submit({
			                    ...
			                    scope: this,
			                    params:{level: 5,recodeGridJson: Ext.JSON.encode(rowsDatas)},
