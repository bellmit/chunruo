...
Ext.define('MyExt.systemManager.WebUrlFormPanel', {
    extend : 'Ext.form.Panel',
    alias: ['widget.webUrlForm'],
		...
		this.items = [{
			...
			title: '<fmt:message key="web.url.detail"/>',
           	...
           	items: [{
					...
					xtype: 'textfield',
			    	fieldLabel: '<fmt:message key="web.url.name" />',
			    	labelWidth: 70,
					name: 'name',
		         	allowBlank: false,
		         	anchor: '98%'
					...
					xtype: 'textfield',
			    	fieldLabel: '<fmt:message key="web.url.url" />',
			    	labelWidth: 70,
					name: 'url',
		         	allowBlank: false,
		         	anchor: '95%'
					...
					xtype: 'textfield',
			    	fieldLabel: '<fmt:message key="web.url.methodName" />',
			    	labelWidth: 70,
					name: 'methodName',
		         	allowBlank: false,
		         	anchor: '95%'
