...
Ext.define('MyExt.systemManager.HomePopupFormPanel', {
    extend : 'Ext.form.Panel',
    alias: ['widget.homePopupForm'],
    requires : [
	    ...
	    this.items = [{
			...
			anchor:'95%'
		        ...
		        items: [
             		...
             		{boxLabel: '<fmt:message key="system.send.msg.objectType10" />', name: '<fmt:message key="system.send.msg.objectType10" />',inputValue:'10',anchor:'100%'},
         		]
			},{
				xtype: 'imagefieldset',
    ...
    saveHomePopup : function(){
    	var rowsData = [];    
         ...
         var levels = [];
			var items = this.down('checkboxgroup[name=level]').items;   
				...
				if(e == 'yes'){
             		this.form.submit({
                 		...
                 		url: '<c:url value="/homePopup/saveHomePopup.json"/>',
               			scope: this,
               			params:{recodeGridJson: Ext.JSON.encode(rowsData),level:Ext.JSON.encode(levels)},
