...
Ext.define('StoreWholesaleHistory', {
...
Ext.define('MyExt.storeManager.StoreWholesaleHistoryList', {
    extend : 'Ext.grid.GridPanel',
    alias: ['widget.storeWholesaleHistoryList'],
    requires : [],
	region: 'center',
	autoScroll: true,   
	multiSelect: true,
