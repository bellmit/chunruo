...
Ext.define('MyExt.teamTaskManager.TeamTaskDeclareWaitListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/teamTask/list.json?level=2&taskStatus=2"/>',
				reader: {
					type : 'json',
                	root: 'data',
	   ...
	   this.tbar = [{
        	...
        	text: '<fmt:message key="team.task.record.unagree"/>', 
        	iconCls: 'delete', 	
        	handler: this.unpromotion,
        	scope: this
        }];
