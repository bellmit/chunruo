...
Ext.define('MyExt.teamTaskManager.TeamTaskDeclareAllListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/teamTask/list.json?level=2"/>',
				reader: {
					type : 'json',
                	root: 'data',
        ...
        this.tbar = ['->',{
        	...
        	iconCls: 'excel', 	
        	handler: this.exportDeclarRecord,
        	scope: this
        } ];
