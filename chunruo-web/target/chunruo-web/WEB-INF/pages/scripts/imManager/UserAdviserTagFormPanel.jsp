...
Ext.define('MyExt.imManager.UserAdviserTagFormPanel', {
    extend : 'Ext.form.Panel',
    alias: ['widget.userAdviserTagForm'],
    requires : [
	...
	initComponent : function(config) {
		...
		this.items = [{
			...
			title: '<fmt:message key="purchase.limit.save"/>',
           	...
           	items: [{
				xtype: 'numberfield',
		    	fieldLabel: '<fmt:message key="user.adviser.tag.sort" />',
		    	labelWidth: 80,
				name: 'sort',
	         	allowBlank: false,
	         	anchor: '98%',
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="user.adviser.tag.name" />',
		    	labelWidth: 80,
				name: 'name',
	         	allowBlank: false,
	         	anchor: '98%',
