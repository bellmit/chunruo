...
Ext.define('MyExt.orderManager.OrderErpWarehousePanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			sortOnLoad: true,
			remoteSort: true,
			model: 'OrderErpWarehouse',
			proxy: {
				type: 'ajax',
				url: '<c:url value="/order/orderErpWarehouseList.json"/>',
				reader: {
					type : 'json',
                	root: 'data',
		...
		this.columns = [
        	...
        	{text: '<fmt:message key="order.wareHouseId"/>', dataIndex: 'wareHouseId', width: 75, sortable : true,
        		filter: {xtype: 'textfield'}
        	},
        	{text: '<fmt:message key="order.wareHouseName"/>', dataIndex: 'wareHouseName', width: 120, sortable : false,
        		filter: {xtype: 'textfield'}
        	},
        	...
        	{text: '<fmt:message key="order.payAmount"/>', dataIndex: 'payAmount', width: 100, sortable : true,
        		filter: {xtype: 'textfield'}
        	},
		...
		<jkd:haveAuthorize access="/order/orderErpWarehouseList.json?isExporter=true">
    	...
    	<jkd:haveAuthorize access="/order/orderErpWarehouseList.json">
