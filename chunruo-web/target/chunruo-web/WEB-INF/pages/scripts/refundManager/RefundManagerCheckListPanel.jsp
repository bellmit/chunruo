...
Ext.define('MyExt.refundManager.RefundManagerCheckListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			sortOnLoad: true,
			remoteSort: true,
			model: 'RefundManagerCheck',
			proxy: {
				type: 'ajax',
				url: '<c:url value="/refund/list.json?status=7"/>',
				reader: {
					type : 'json',
                	root: 'data',
