...
Ext.define('MyExt.userManager.InvitesCourtesyFormPanel', {
    extend : 'Ext.form.Panel',
    alias: ['widget.invitesCourtesyForm'],
    requires : [
		...
		this.items = [{
			...
			title: '<fmt:message key="invites.courtesy.detail"/>',
           	...
           	items: [{
						xtype: 'combobox',
						labelWidth: 60,
						fieldLabel: '<fmt:message key="invites.courtesy.level" />',
						name: 'level',
				        displayField: 'name',
				        valueField: 'id',
					...
					xtype: 'imagefieldset',
					title: '<fmt:message key="invites.courtesy.headerImage"/>',
					collapsible: false,
					anchor: '98%',
					items: [{
						xtype: 'imagepanel',
					...
					xtype: 'imagefieldset',
					title: '<fmt:message key="invites.courtesy.imagePath"/>',
					collapsible: false,
					anchor: '98%',
					items: [{
						xtype: 'imagepanels',
