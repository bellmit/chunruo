...
Ext.define('MyExt.productManager.FirstCategoryPicker', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.firstCategoryPicker',
    ...
    initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			sortOnLoad: true,
			remoteSort: true,
			model: 'XFirstCategory',
			proxy: {
				type: 'ajax',
				url: '<c:url value="/brand/XFirstCategoryList.json"/>',
				reader: {
					type : 'json',
                	root: 'data',
