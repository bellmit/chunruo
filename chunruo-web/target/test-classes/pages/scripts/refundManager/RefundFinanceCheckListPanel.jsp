...
Ext.define('MyExt.refundManager.RefundFinanceCheckListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			sortOnLoad: true,
			remoteSort: true,
			model: 'RefundFinanceCheck',
			proxy: {
				type: 'ajax',
				url: '<c:url value="/refund/list.json?status=8"/>',
				reader: {
					type : 'json',
                	root: 'data',
