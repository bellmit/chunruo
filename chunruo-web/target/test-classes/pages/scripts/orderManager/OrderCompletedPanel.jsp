...
Ext.define('MyExt.orderManager.OrderCompletedPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/order/orderCompletedList.json"/>',
				reader: {
					type : 'json',
                	root: 'data',
		...
		this.columns = [
        	...
        	{text: '<fmt:message key="order.profitSub"/>', dataIndex: 'profitSub', width: 80, sortable : true,
        		filter: {xtype: 'textfield'}
        	},
		...
		<jkd:haveAuthorize access="/order/orderCompletedList.json?isExporter=true">
    	...
    	<jkd:haveAuthorize access="/order/orderCompletedList.json">
