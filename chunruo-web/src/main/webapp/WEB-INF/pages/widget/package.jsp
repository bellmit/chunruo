...
<script type="text/javascript">
    var currentPage = 1,
        keyword = '';
    $(function() {
        sendAjax.get("widget/getProductPackage", {
        ...
        $("#pagediv").html("");
            ...
            var pageHtml = "";
                html += '<tr><td class="title" style="max-width: 300px;">' +
                    '<div class="td-cont">' +
                    '<a class="new_window" href="javascript:void(0);">' + page.name + '</a>' +
                    '</div>' +
                    '</td> ' +
                    '<td class="time"> ' +
                    '<div class="td-cont"> ' +
                    ...
                    '<td class="opts">' +
                    '<div class="td-cont">' +
                    '<button class="btn js-choose" onclick="selectProduct(this)" data-id="' + page.productId + '" data-title="' + page.name + '" data-price="' + page.price + '" data-image="/upload/' + page.image + '">选取</button>' +
                    '</div></td></tr>'
    ...
    function selectProduct(obj) {
        ...
        if (type && type != "null" && type == 1) {
            parent.login_box_after(parent.randNum, 'package', $(obj).data('title'), $(obj).data('id'));
        } else {
