...
Ext.define('MyExt.productTaskManager.ProductTaskListPanel', {
	...
	initComponent : function(config) {
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/productTask/list.json"/>',
				reader: {
					type : 'json',
                	root: 'data',
		...
		this.columns = [
			{text: '<fmt:message key="product.task.taskId"/>', dataIndex: 'taskId', width: 50, sortable: true, align: 'center',filter: {xtype: 'textfield'}},
			{text: '<fmt:message key="product.task.taskName"/>', dataIndex: 'taskName',  align: 'center',     width: 260, sortable: true, filter: {xtype: 'textfield'}},
			{text: '<fmt:message key="product.task.productId"/>',    dataIndex: 'productId', align: 'center',   width: 60, sortable: true,  filter: {xtype: 'textfield'}},
			{text: '<fmt:message key="product.task.productName"/>',  dataIndex: 'productName',  align: 'center',     width: 260, sortable: true, filter: {xtype: 'textfield'}},
			{text: '<fmt:message key="product.task.isEnable"/>', dataIndex: 'isEnable', width: 65, sortable : true,
        		align: 'center',
			...
			{text: '<fmt:message key="product.task.taskNumber"/>',   dataIndex: 'taskNumber', align: 'center',  width: 80, sortable: true,  filter: {xtype: 'textfield'}},
			{text: '<fmt:message key="product.task.reward"/>', dataIndex: 'reward',     align: 'center',  width: 100, sortable: true, filter: {xtype: 'textfield'}},
        	{text: '<fmt:message key="product.task.maxGroupNumber"/>',       dataIndex: 'maxGroupNumber',   align: 'center',    width: 100, sortable: true, filter: {xtype: 'textfield'}},
        	{text: '<fmt:message key="product.task.beginTime"/>',     dataIndex: 'beginTime',     width: 150, sortable: true, align: 'center', filter: {xtype: 'textfield'}}, 
			{text: '<fmt:message key="product.task.endTime"/>',dataIndex: 'endTime',       width: 150, sortable: true, align: 'center',filter: {xtype: 'textfield'}},
		...
		<jkd:haveAuthorize access="/productTask/deleteProductTask.json">
		<c:if test="${isHaveAuthorize}">,</c:if>
        {
		...
		<jkd:haveAuthorize access="/productTask/updateIsEnable.json">
		<c:if test="${isHaveAuthorize}">,</c:if>
        {
	    ...
	    this.productList.on('itemdblclick', function(view, record, item, index, e, eOpts) {
	    	<jkd:haveAuthorize access="/productTask/getProductTaskById.json">
