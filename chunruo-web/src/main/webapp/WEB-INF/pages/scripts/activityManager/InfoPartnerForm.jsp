...
Ext.define('MyExt.activityManager.InfoPartnerForm', {
    	...
    	var form = Ext.create('Ext.form.Panel', {
			...
			value:this.infoId
            	...
            	items: [{
			           ...
			           xtype: 'textfield',
			           labelWidth: 70,
			           fieldLabel: '<fmt:message key="acitivity.info.title"/>',
			           anchor:'99%',
			           name: 'title',
			           value: this.title,
			           width:400
			           ...
			           xtype: 'textarea',
			           labelWidth: 70,
			           fieldLabel: '<fmt:message key="acitivity.info.introduce"/>',
			           anchor:'99%',
			           name: 'introduce',
			           value: this.introduce,
			           height:100,
			           width:400
		           },{
					xtype: 'imagefieldset',
