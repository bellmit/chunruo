...
Ext.define('MyExt.activityManager.InfoGuideListPanel', {
    ...
    initComponent : function(config) {
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/activity/infoList.json?level=6"/>',
				reader: {
					type : 'json',
                	root: 'data',
	    ...
	    this.columns = [
			...
			{text: '<fmt:message key="activity.info.content"/>', dataIndex: 'content', align: 'center', width: 500, sortable: true, locked: true, filter: {xtype: 'textfield'}},
    ...
    saveInfo : function(){
    var rowsData = [];		
    	var infoFormPanel = Ext.create('MyExt.activityManager.InfoFormPanel', {
