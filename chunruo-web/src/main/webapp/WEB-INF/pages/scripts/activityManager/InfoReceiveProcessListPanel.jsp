...
Ext.define('MyExt.activityManager.InfoReceiveProcessListPanel', {
    ...
    initComponent : function(config) {
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/activity/infoList.json?level=3"/>',
				reader: {
					type : 'json',
                	root: 'data',
				...
				Ext.MessageBox.confirm('<fmt:message key="ajax.confirm"/>', '<fmt:message key="save.confirm"/>', function(e){
					if(e == 'yes'){
	             		infoFormPanel.form.submit({
			                    ...
			                    scope: this,
			                    params:{level: 3,recodeGridJson: Ext.JSON.encode(rowsDatas)},
