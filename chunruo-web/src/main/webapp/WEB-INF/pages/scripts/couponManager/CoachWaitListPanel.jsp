...
Ext.define('MyExt.couponManager.CoachWaitListPanel', {
	...
	initComponent : function(config) {
    	...
    	this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/coach/list.json?status=1"/>',
				reader: {
					type : 'json',
                	root: 'data',
