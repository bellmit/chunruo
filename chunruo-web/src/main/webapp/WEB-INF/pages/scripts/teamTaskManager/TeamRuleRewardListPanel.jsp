...
Ext.define('MyExt.teamTaskManager.TeamRuleRewardListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/teamTask/ruleQuestionlist.json?type=3"/>',
				reader: {
					type : 'json',
                	root: 'data',
	    ...
	    this.tbar = [{
        	text: '<fmt:message key="team.rule.reward.add"/>', 
            iconCls: 'add', 
            scope: this,
        	handler: this.adds, 
        	
        },{
        	text: '<fmt:message key="team.rule.reward.edit"/>', 
            iconCls: 'Chartpieadd',
        	handler: this.edit, 
        	scope: this
        },{
