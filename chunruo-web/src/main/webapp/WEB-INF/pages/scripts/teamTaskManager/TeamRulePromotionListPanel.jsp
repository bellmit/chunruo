...
Ext.define('MyExt.teamTaskManager.TeamRulePromotionListPanel', {
	...
	initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/teamTask/ruleQuestionlist.json?type=1"/>',
				reader: {
					type : 'json',
                	root: 'data',
	    ...
	    this.tbar = [{
        	text: '<fmt:message key="team.rule.promotion.add"/>', 
            iconCls: 'add', 
            scope: this,
        	handler: this.adds, 
        	
        },{
        	text: '<fmt:message key="team.rule.promotion.edit"/>', 
            iconCls: 'Chartpieadd',
        	handler: this.edit, 
        	scope: this
        },{
