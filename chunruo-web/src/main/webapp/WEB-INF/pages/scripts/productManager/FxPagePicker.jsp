...
Ext.define('MyExt.productManager.FxPagePicker', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.fxPagePicker',
    ...
    initComponent : function(config) {
		...
		this.store = Ext.create('Ext.data.Store', {
			...
			proxy: {
				type: 'ajax',
				url: '<c:url value="/category/XFxPageList.json"/>',
				reader: {
					type : 'json',
                	root: 'data',
    ...
    createPicker: function() {
       	this.productPicker = Ext.create('Ext.grid.GridPanel', {
	        ...
	        columns: [{
	        	text: '<fmt:message key="fx.page.id"/>', 
	        	dataIndex: 'pageId', 
	        	width: 60, 
	        	sortable: true
	        },{
            	text: '<fmt:message key="fx.page.name"/>',
            	width: 600,
            	sortable: true,
            	dataIndex: 'pageName'
        	}],
