...
Ext.define('MyExt.evaluateManager.EvaluateFormPanel', {
	...
	initComponent : function(config) {
	    ...
	    this.items = [{
			...
			title: '<fmt:message key="evaluate.detail"/>',
           	...
           	items: [{
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.evaluateId" />',
		    	labelWidth: 70,
				name: 'evaluateId',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.userId" />',
		    	labelWidth: 70,
				name: 'userId',
	         	readOnly: true,
	         	anchor: '95%'
			    ...
			    {
				    xtype:'textfield',
				    fieldLabel: '<fmt:message key="order.evaluate.productName"/>',
				    labelWidth: 85,
				    readOnly: true,
				    name: 'productName',
				    anchor:'95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.orderId" />',
		    	labelWidth: 70,
				name: 'orderId',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.itemId" />',
		    	labelWidth: 70,
				name: 'itemId',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.status" />',
		    	labelWidth: 70,
				name: 'status',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.score" />',
		    	labelWidth: 70,
				name: 'score',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textfield',
		    	fieldLabel: '<fmt:message key="order.evaluate.evaluateRate" />',
		    	labelWidth: 70,
				name: 'evaluateRate',
	         	readOnly: true,
	         	anchor: '95%'
				...
				xtype: 'textarea',
		    	fieldLabel: '<fmt:message key="order.evaluate.content" />',
		    	labelWidth: 70,
				name: 'content',
				height: 100,
				readOnly: true,
