...
public class WeiXinPayUtil {
	...
	public static MsgModel<Double> getQueryRefundInfo(WeChatAppConfig weChatAppConfig, String transactionId, String outTradeNo,Double refundFee,Double totalFee,String refundNumber){
		...
		try{
	        ...
	        String certUrl = "";
	        if(StringUtil.compareObject(weChatAppConfig.getConfigId(), 1)) {
	        	certUrl = StringUtil.nullToString((Constants.conf.getProperty("jkd.weixin.weidian.cert")));
	        }else {
	        	certUrl = StringUtil.nullToString((Constants.conf.getProperty("jkd.weixin.app.cert")));
	        }
